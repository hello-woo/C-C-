...
##### vector中的push_back和empalce_back的区别

empalce的这些操作构造而不是拷贝元素，当调用push函数时，我们将元素类型的对象传递给他们，这些对象被拷贝到容器中，而调用empalce函数时，则是将参数传递给元素类型的构造函数，emplace成员使用这些参数在容器管理的内存空间中之间构造元素。
...
![image-20210315134553954](E:\Study_Notes\图片\五状态模型)
...
![image-20210315135352577](E:\Study_Notes\图片\七状态)
...
![image-20210315225451408](E:\Study_Notes\图片\epoll的ET和LT模式)
...
![IP 数据报格式](E:\Study_Notes\图片\IP数据报文)

**ICMP 网际控制报文协议**

ICMP 报文格式：

![img](E:\Study_Notes\图片\ICMP报文格式.png)
...
![image-20201224200043183](E:\Study_Notes\图片\TCP报文结构)

**TCP 首部**

![image-20201224200118805](E:\Study_Notes\图片\TCP首部)
...
![image-20201224200453357](E:\Study_Notes\图片\UDP报文结构)

**UDP 首部**

![image-20201224200537655](E:\Study_Notes\图片\UDP首部)
...
![image-20201224201138425](E:\Study_Notes\图片\可变窗口进行留下流量控制)
...
- 慢开始( slow-start )
- ![image-20201227212444465](E:\Study_Notes\慢开始)
- 拥塞避免( congestion avoidance )
- ![image-20201227212953953](E:\Study_Notes\拥塞避免1)
- ![image-20201227212758909](E:\Study_Notes\拥塞避免)
- 快重传( fast retransmit )
- ![image-20201227213032119](E:\Study_Notes\快速重传)
- 快恢复( fast recovery )
- ![image-20201227213122177](E:\Study_Notes\快速恢复)

##### TCP 传输连接管理

###### TCP 三次握手建立连接

![image-20201228202437572](E:\Study_Notes\三次握手)
...
![image-20201228202803695](E:\Study_Notes\四次挥手)
...
![img](E:\Study_Notes\TCP的有限状态机.png)
...
<img src="E:\Study_Notes\图片\互斥锁" alt="img" style="zoom:50%;" />
...
<img src="E:\Study_Notes\图片\读优先锁" alt="img" style="zoom:50%;" />
...
<img src="E:\Study_Notes\图片\写优先级锁" alt="img" style="zoom:50%;" />
...
![preview](E:\Study_Notes\图片\跳表)

​		假设我们现在要查找区间 7- 13 的记录，再也不用从头开始查找了，只要在上图中的二级索引开始找即可，遍历三次即可找到链表的区间位置，时间复杂度是 O(logn)，

**平衡二叉树：**

![image-20210315201621190](E:\Study_Notes\图片\平衡为叉树)

改造成为B+树：

![img](E:\Study_Notes\图片\B+树)
...
> 1. 分配内存
> 2. 调用构造函数
> 3. 复制指针，多线程环境下，cpu指令reorder，1，3，2，这样先赋值指针，是一个野指针。
